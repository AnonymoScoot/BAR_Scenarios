local scenariodata = {
	index			= 37, --  integer, sort order, MUST BE EQUAL TO FILENAME NUMBER
	scenarioid		= "onyx01", -- no spaces, lowercase, this will be used to save the score and can be used gadget side
    version         = "1", -- increment this to reset the score when changing a mission, as scores are keyed by (scenarioid,version,difficulty)
	title			= "Onyx", -- can be anything
...
Scoring:
 ...
 - Resources spent to complete the victory condition
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
        ...
        scenarioid = "onyx01", -- this MUST be present and identical to the one defined at start
