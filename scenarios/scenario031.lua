local scenariodata = {
	...
	briefing          =
	[[Five opposing commanders have been deployed at the base of a resource-rich volcanic rise, together preparing to secure the summit. Their intel missed one detail: routine lava surges sweep the terrain. Hold your position and outlast the competition to claim the hill as its rightful prince.
